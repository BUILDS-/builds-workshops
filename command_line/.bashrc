...
function chrome(){ /mnt/c/Program\ Files\ \(x86\)/Google/Chrome/Application/chrome.exe; }

# Calls adb from the installed portable tools. If the path to the executable changes or the full SDK is installed, edit this command accordingly.
function adb(){ /mnt/c/Windows/System32/cmd.exe /C "C:/Users/markb/Programs/platform-tools/platform-tools/adb.exe $@"; }


# Alias to open up Jupyter Notebook (via Windows CMD)
alias jupyter="cmd jupyter notebook"

# Add a shortcut to logon to csa2
# Change username to your own username!
alias csa="ssh markbest@csa2.bu.edu"
